...
var Rhea = function () {
	...
	/* init the datatable with export and filter */
	var handleInitDatatable4 = function($dom, filter) {
	...
	return {
		...
		initDatatableWithExport2: function($dom, filter) {
			handleInitDatatable4($dom, filter);
		},
