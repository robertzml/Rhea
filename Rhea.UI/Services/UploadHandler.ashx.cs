    ...
    public class UploadHandler : IHttpHandler
    {
        ...
        private void UploadWholeFile(HttpContext context, List<FilesStatus> statuses)
        {
            for (int i = 0; i < context.Request.Files.Count; i++)
            {
                ...
                statuses.Add(new FilesStatus(fullName, file.ContentLength, fullPath, file.ContentType));
            }
        }
        ...
        private string StorageRoot
        {
            ...
            get
            {
                return Path.Combine(System.Web.HttpContext.Current.Server.MapPath("~/Attachment/svg/"));
            }
        }
        #endregion //Property
    }
